...
export function __wbg_get_workspaceandoutput_output(a: number): Array;
...
export function closure2958_externref_shim(a: number, b: number, c: number): void;
export function __wbindgen_free(a: number, b: number, c: number): void;
export function __externref_table_alloc(): number;
export function __wbindgen_exn_store(a: number): void;
export function closure3041_externref_shim(a: number, b: number, c: number, d: number): void;
