...
export interface InitOutput {
  ...
  readonly __wbg_get_workspaceandoutput_output: (a: number) => Array;
  ...
  readonly closure2958_externref_shim: (a: number, b: number, c: number) => void;
  readonly __wbindgen_free: (a: number, b: number, c: number) => void;
  readonly __externref_table_alloc: () => number;
  readonly __wbindgen_exn_store: (a: number) => void;
  readonly closure3041_externref_shim: (a: number, b: number, c: number, d: number) => void;
