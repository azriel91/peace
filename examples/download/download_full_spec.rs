...
use crate::{
    DownloadCleanOpSpec, DownloadEnsureOpSpec, DownloadError, DownloadStatusDesiredFnSpec,
    DownloadStatusFnSpec, FileState,
};
...
impl FullSpec for DownloadFullSpec {
    ...
    type StatusDesiredFnSpec = DownloadStatusDesiredFnSpec;
