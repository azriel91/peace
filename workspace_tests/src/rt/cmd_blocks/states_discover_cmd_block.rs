use peace::{
    cmd_rt::CmdBlock, rt::cmd_blocks::StatesDiscoverCmdBlock, rt_model::params::ParamsKeysUnknown,
};
...
fn input_type_names_includes_states_compared() {
    macro_rules! assert_input_type_names {
        ($constructor:ident) => {
            let cmd_block =
                StatesDiscoverCmdBlock::<PeaceTestError, ParamsKeysUnknown, _>::$constructor();
