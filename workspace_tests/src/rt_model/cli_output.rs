...
#[tokio::test]
async fn outputs_states_previous_as_text() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let states_previous = {
        ...
        StatesPrevious::from(states)
    };

    <CliOutput<_> as OutputWrite<Error>>::write_states_previous(&mut cli_output, &states_previous)
        .await?;
...
#[tokio::test]
async fn outputs_states_previous_as_text_colorized() -> Result<(), Box<dyn std::error::Error>> {
    let mut buffer = Vec::with_capacity(128);
...
#[tokio::test]
async fn outputs_states_previous_as_yaml() -> Result<(), Box<dyn std::error::Error>> {
    let mut buffer = Vec::with_capacity(128);
...
#[tokio::test]
async fn outputs_states_previous_as_json() -> Result<(), Box<dyn std::error::Error>> {
    let mut buffer = Vec::with_capacity(128);
