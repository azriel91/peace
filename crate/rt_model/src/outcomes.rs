...
macro_rules! box_data_type_newtype {
    ($ty_name:ident, $trait_path:path) => {
        ...
        impl<T> peace_resource_rt::type_reg::untagged::BoxDataTypeDowncast<T> for $ty_name
        where
            T: $trait_path,
        {
        ...
        impl peace_resource_rt::type_reg::untagged::DataTypeWrapper for $ty_name {
            fn type_name(&self) -> peace_resource_rt::type_reg::TypeNameLit {
                peace_resource_rt::type_reg::untagged::DataType::type_name(&*self.0)
            }
            ...
            fn inner(&self) -> &dyn peace_resource_rt::type_reg::untagged::DataType {
                &self.0
            }
        }
    };
