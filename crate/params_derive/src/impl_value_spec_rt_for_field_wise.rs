            ...
            fields_named
                ...
                .fold(
                    ...
                    |mut tokens, (field, field_name)| {
                        ...
                        let resolve_value =
                            resolve_mode.resolve_value(peace_params_path, field_name, field);
            ...
            fields_unnamed
                ...
                .fold(
                    ...
                    |mut tokens, (field_index, field)| {
                        ...
                        let field_ty = &field.ty;
                        let resolve_value =
                            resolve_mode.resolve_value(peace_params_path, &field_ident, field);
...
impl ResolveMode {
    ...
    fn resolve_value(
        ...
        let field_spec_ty = field_spec_ty(peace_params_path, &field.ty);
