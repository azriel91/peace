...
pub struct CmdCtxSpsfBuilder<'ctx, CmdCtxTypesT>
where
...
impl<
        ...
        __workspace_params_type_reg: ::typed_builder::Optional<TypeReg<CmdCtxTypesT::WorkspaceParamsKey, BoxDt>>,
        __profile_params_type_reg: ::typed_builder::Optional<TypeReg<CmdCtxTypesT::ProfileParamsKey, BoxDt>>,
        __flow_params_type_reg: ::typed_builder::Optional<TypeReg<CmdCtxTypesT::FlowParamsKey, BoxDt>>,
        __resources: ::typed_builder::Optional<Resources<Empty>>,
    >
    CmdCtxSpsfBuilderBuilder<
        'ctx,
        CmdCtxTypesT,
        (
    ...
    CmdCtxTypesT: CmdCtxTypes,
{
    pub async fn build(self) -> Result<CmdCtxSpsf<'ctx, CmdCtxTypesT>, CmdCtxTypesT::AppError> {
        ...
        let params_specs_stored =
            peace_rt_model::ParamsSpecsSerializer::<peace_rt_model::Error>::deserialize_opt(
                &profile,
                flow_id,
                storage,
