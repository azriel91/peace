// Taken from https://cdn.jsdelivr.net/npm/highlightjs-line-numbers.js@2.8.0/dist/highlightjs-line-numbers.min.js
//
...
// * Chanaged `t[o]:" "` to `t[o]:"<br/>"`, so that copied code has an empty newline instead of a line with a space character.
